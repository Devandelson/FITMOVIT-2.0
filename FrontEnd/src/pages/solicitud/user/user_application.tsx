...
// components
import { TextInput, SelectInput, Button } from '../components.tsx';
                ...
                ">
                    ...
                    <div className="text-center mb-7">
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                            Únase a la red de transporte inteligente FITMOVIT
                        </p>
                    </div>
                    ...
                    <div className="flex rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <button
                            ...
                            onClick={() => { ChangeView("/solicitud/institucion") }}
                        >
                    ...
                    <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <SelectInput
                            id="transportGroup"
                            label="Transportes tomados frecuentemente"
                            required
                            options={[
                                { value: "", label: "Seleccione un transporte" },
                                { value: "Transporte1", label: "Transporte 1" },
                                { value: "Transporte2", label: "Transporte 2" },
                            ]}
                        />
